...
(library Library_1
	...
	(compDef "BU33SD5WG-TR" (originalName "BU33SD5WG-TR") (compHeader (numPins 5) (numParts 1) (refDesPrefix PS)
		...
		(compPin "3" (pinName "STBY") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/BU33SD5WG-TR.pdf")
		(attr "<Component Height>" "1.25")
		(attr "<STEP Filename>" "BU33SD5WG-TR.stp")
